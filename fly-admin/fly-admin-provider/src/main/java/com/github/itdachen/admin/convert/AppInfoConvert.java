...
public class AppInfoConvert implements IBizConvertMapper< AppInfo, AppInfoDTO, AppInfoVO > {
    ...
    public AppInfo toJavaObject(AppInfoDTO appInfoDTO) {
        ...
        AppInfo appInfo = new AppInfo();
                ...
                appInfo.setAppAsTitle(appInfoDTO.getAppAsTitle());
                appInfo.setAppType(appInfoDTO.getAppType());
    ...
    public AppInfoVO toJavaObjectVO(AppInfo appInfo) {
        if (null == appInfo){
            ...
            AppInfoVO appInfoVO = new AppInfoVO();
                    ...
                    appInfoVO.setAppAsTitle(appInfo.getAppAsTitle());
                    appInfoVO.setAppType(appInfo.getAppType());
    ...
    public AppInfo toJavaObject(AppInfoVO appInfoVO) {
        ...
        AppInfo appInfo = new AppInfo();
                ...
                appInfo.setAppAsTitle(appInfoVO.getAppAsTitle());
                appInfo.setAppType(appInfoVO.getAppType());
    ...
    public AppInfoVO toJavaObjectVO(AppInfoDTO appInfoDTO) {
        if (null == appInfoDTO){
            ...
            AppInfoVO appInfoVO = new AppInfoVO();
                    ...
                    appInfoVO.setAppAsTitle(appInfoDTO.getAppAsTitle());
                    appInfoVO.setAppType(appInfoDTO.getAppType());
