...
public class DeptInfoQuery extends BizQuery implements Serializable {
    ...
    public DeptInfoQuery(int page, int limit, String tenantId, String parentId, String title, String deptFlag, String thatLevel, String levelCode, String funcCode, String provId, String cityId, String countyId, String validFlag, String deleteFlag) {
        super(page, limit);
    ...
    public static class DeptInfoQueryBuilder {
        ...
        public DeptInfoQuery build() {
            return new DeptInfoQuery(page, limit, tenantId, parentId, title, deptFlag, thatLevel, levelCode, funcCode, provId, cityId, countyId, validFlag, deleteFlag);
        }
