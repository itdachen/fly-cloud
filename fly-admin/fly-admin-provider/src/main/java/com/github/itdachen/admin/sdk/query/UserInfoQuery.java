...
public class UserInfoQuery extends BizQuery implements Serializable {
    ...
    public UserInfoQuery(int page, int limit, String tenantId, String nickName, String idCard, String sex, String telephone, String validFlag, String delFlag) {
        super(page, limit);
    ...
    public static class UserInfoQueryBuilder {
        ...
        public UserInfoQuery build() {
            return new UserInfoQuery(page, limit, tenantId, nickName, idCard, sex, telephone, validFlag, delFlag);
        }
