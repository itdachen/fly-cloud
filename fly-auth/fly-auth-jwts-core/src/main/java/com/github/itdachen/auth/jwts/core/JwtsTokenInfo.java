 ...
 */
public class JwtsTokenInfo implements IJwtsInfo{
    ...
    public JwtsTokenInfo(String username, String userId, String nickName) {
    ...
    public JwtsTokenInfo(String username,
                         String userId,
                         String nickName,
                         String subject,
                         Date expireTime,
    ...
    public JwtsTokenInfo(Builder builder) {
    ...
    public static class Builder {
        ...
        public JwtsTokenInfo build() {
            return new JwtsTokenInfo(this);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        JwtsTokenInfo jwtInfo = (JwtsTokenInfo) o;
