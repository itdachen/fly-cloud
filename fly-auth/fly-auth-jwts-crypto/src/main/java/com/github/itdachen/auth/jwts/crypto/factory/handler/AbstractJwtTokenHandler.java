...
import com.github.itdachen.auth.jwts.crypto.constants.JWTHeader;
...
public abstract class AbstractJwtTokenHandler {
    ...
    protected JwtsProperties properties;
     ...
     */
    public abstract String createToken(IJwtsInfo jwtInfo, String signingKey, Long expires) throws Exception;
     ...
     * @return java.lang.String
     */
    protected String createJwtToken(IJwtsInfo jwtInfo,
     ...
     */
    protected Map<String, Object> createClaimsMap(IJwtsInfo jwtInfo) {
