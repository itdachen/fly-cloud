  ...
  <lay-layer v-model="layerRef.open"
    ...
    <div style="padding: 20px">
      <lay-form :model="deptInfo" ref="layDeptInfoForm">
        ...
        <lay-form-item label="所在区县" prop="countyId" :required="layerRef.required" @change="funcCodeChangeFilter" mode="inline">
        ...
        <lay-form-item label="机构名称" prop="title" :required="layerRef.required">
          <lay-input v-model="deptInfo.title" :disabled="layerRef.disabled"></lay-input>
        </lay-form-item>

        <lay-form-item label="机构简称" prop="titleAs">
...
<script setup lang="ts" name="refDeptOrg">
import {onMounted, reactive, ref} from "vue";
import {FormTypeEnum} from "@/fly/biz/BizModel";
import {DeptInfo} from "@/api/admin/model/DeptInfoModel";
import useTenantInfoComposable from "@/composables/admin/DeptOrgComposable";
